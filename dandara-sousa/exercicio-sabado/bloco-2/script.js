...
const frutas = ["melancia", "banana", "mamão", "abacate", "laranja"];

//2. Crie uma array com 100 espaços vazios.

const arrayCem = new Array(100) //exemplo da prof
...
for(let i=0; i < frutas.length; i++) {
  ...
  //acertei e nem acredito, porém não sei como fiz
...
/*qualquer looping vai dar certo*/
...
//escopo é tudo que acontece dentro do {} (e fica ali dentro)
