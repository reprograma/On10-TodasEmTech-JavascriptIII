...
```
1. O que é iteração?
repetir uma ação multiplas vezes

2. Qual a diferença de uma function padrão e a arrow function?
A arrow function tem uma sintaxe mais curta, tem nome enquanto functions são mais loongas e devem ter retorno.

3. Como funciona o método map()? 
O método map passa por cada elemento de uma array e retorna um novo array com base nos resultados.
