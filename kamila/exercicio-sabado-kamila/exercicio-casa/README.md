...
É a forma de executar uma ação repetidas vezes.

2. Qual a diferença de uma function padrão e a arrow function?

A arrow function se diferencia da function por sua sintaxe curta.

3. Como funciona o método map()? 
O método map chama a função callback que recebeu o parametro do Array original e retorna um novo array.
